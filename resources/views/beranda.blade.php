...
<head>
    ...
    <title> Dasbor | Beban Kerja Dosen</title>
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index.html" class="brand-link">
                <img src="dist/img/UMBLogo.png" alt="UMB Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item">
                            <a href="pages/tables/biodata.html" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="pages/tables/pengajaran.html" class="nav-link">
                                <i class="nav-icon fas fa-th"></i>
                                <p>
                                    Pengajaran
                                </p>
