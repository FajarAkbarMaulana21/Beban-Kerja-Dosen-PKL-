                                            ...
                                            <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="vertical-align:middle">
                                                            @if($item->rekomendasi == 'Diproses')
                                                            <a href="{{route('sendtoassesorpenelitian', $item->id)}}" class="btn btn-primary btn-sm"><i class="fas fa-paper-plane"></i></a>
                                                            @endif
                                                            <a href="{{route('penelitian.show', $item->id)}}" class="btn btn-secondary btn-sm"><i class="fas fa-eye"></i></a>
