                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="btn-tmbh float-right">
                                <a href="{{route('penunjang.create')}}" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i>Tambah</a>
                            </div>
                        </div>
                                    ...
                                    <div class="col-sm-12">
                                        <table id="example1"
                                            ...
                                            <tbody>
                                                    ...
                                                    <tr>
                                                        <td style="vertical-align:middle;text-align:center">{{$item->id_penunjang}}</td>
                                                        <td style="vertical-align:middle">{{$item->subkegiatan}}</td>
