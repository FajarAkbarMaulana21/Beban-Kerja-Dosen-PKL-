        ...
        <div class="col-lg-4 col-4">
          ...
          <a href="{{route('kinerja-penelitian.index')}}">
            <div class="card text-center bg-light shadow">
                ...
                <div class="card-footer"><strong style="font-size: 20px">Data Penelitian Masuk</strong></div>
            </div>
            </a>
        </div>
        <div class="col-lg-4 col-4">
            ...
            <a href="{{route('kinerja-penunjang.index')}}">
              <div class="card text-center bg-light shadow">
                  ...
                  <div class="card-footer"><strong style="font-size: 20px">Data Penunjang Masuk</strong></div>
              </div>
              </a>
          </div>
        <!-- ./col -->
