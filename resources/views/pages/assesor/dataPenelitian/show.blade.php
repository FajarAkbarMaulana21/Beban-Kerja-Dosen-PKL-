                        ...
                        <div class="row justify-content-center">
                            <div class="col-12 col-md-8">
                                ...
                                <div class="section-btn text-center">
                                    @if ($data->rekomendasi == 'Diteruskan' || $data->rekomendasi == 'Diperiksa' || $data->rekomendasi == 'Lanjutkan' || $data->rekomendasi == 'Beban Lebih')
                                        <a href="{{route('data-penelitian.selesai', $data->id)}}" class="btn btn-success m-2">Selesai</a>
                                        <a href="" class="btn btn-primary m-2">Lanjutkan</a>
                                        <a href="" class="btn btn-warning m-2">Beban Lebih</a>
                                    @elseif($data->rekomendasi == 'Selesai')
                                        <a href="{{route('data-penelitian.selesai', $data->id)}}" class="btn btn-success m-2 disabled">Selesai</a>
                                        <a href="" class="btn btn-primary m-2 disabled">Lanjutkan</a>
                                        <a href="" class="btn btn-warning m-2 disabled">Beban Lebih</a>
                                    @endif
